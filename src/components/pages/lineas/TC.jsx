...
const TC = () => {
  ...
  <Box position={"absolute"} left={"6%"} top={"150px"} zIndex={100}>
    ...
    >
      La Terapia Cetogénica es un tratamiento no farmacológico y efectivo
      utilizado como una alternativa de tratamiento en el manejo de la epilepsia
      refractaria desde 1921.
    </Typography>
  </Box>
  ...
  >
    <Box width={"100%"} pt={0} p={"3%"}>
      ...
      >
        <strong>
          La línea Terapia Cetogénica de B-Life incluye fórmulas (líquidas y en
          polvo) para todas las etapas de la vida, suplementos vitamínicos y
          minerales, módulos (TCM líquido y en polvo) y alimentos cetogénicos.
        </strong>{" "}
        SATISFACIENDO TODAS LAS NECESIDADES DE LAS FAMILIAS A LA HORA DE INICIAR
    ...
    >
      <Box width={"90%"} m={"auto"}>
        ...
        >
          ...
          epilepsia refractaria o de difícil control desde 1921, que se puede
          utilizar desde la infancia hasta la adultez. Las epilepsias refractarias
          o de difícil control se definen como fallas en el control de las crisis
          al tratamiento con dos fármacos bien tolerados y seleccionados
          adecuadamente.
        </Typography>
        <Typography
          sx={{
        ...
        >
          Consiste en una selección de alimentos que aportan un alto contenido en
          grasas, un bajo contenido en hidratos de carbono y un aporte de
          proteínas recomendados para la edad del paciente, en la cual se utiliza
          la grasa como fuente de energía primaria a través de la formación de
          cuerpos cetónicos (155 libro). Es una dieta rígida, matemáticamente
          calculada, individual y médicamente controlada por un equipo
        ...
        >
          Ya desde la Antigüedad se sabía que el ayuno provocaba una mejoría en el
          control de las convulsiones en pacientes epilépticos.
        </Typography>
        <Typography
          sx={{
            fontFamily: "Lato",
        ...
        >
          En Argentina, el Dr. Natalio Fejerman, médico neurólogo, y la Dra. Nidia
          Escobal, médica nutricionista, fueron los pioneros en el uso de la TC
          hace aproximadamente 50 años. Desde ese momento el desarrollo en nuestro
          país fue cada vez mayor. Actualmente existen centros que utilizan la
          Terapia Cetogénica en el tratamiento de las epilepsias de difícil control
          en diferentes ciudades del país: Buenos Aires, La Plata, Mar del Plata,
          Córdoba, Santa Fé, Rosario, Neuquén, Bariloche, Gualeguaychú, Tucumán,
      ...
      <Box width={"90%"} m={"auto"} mt={1}>
        <Box>
          ...
          >
            ...
            experimentarán una reducción en su frecuencia, mientras que otros
            podrán dejar de ingerir algunos medicamentos que vienen tomando.
          </Typography>
        </Box>
        ...
        >
          Uno de los pilares para favorecer el cumplimiento de la Terapia
          Cetogénica y lograr la adherencia de los niños y sus familias al
          tratamiento es la variedad e individualización de las preparaciones.
        </Typography>
        <Typography
          sx={{
            fontFamily: "Lato",
        ...
        >
          Apelando a la importancia de la variedad en la implementación de la
          Terapia Cetogénica, B-Life cuenta con la más amplia gama de productos
          para llevarla a cabo en todas las etapas de la vida{" "}
          <span
            onMouseEnter={() => {
              setIsHovered(true);
              handleOpen();
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  2. Kossoff EH, Zupec-Kania BA, Auvin S, Ballaban-Gil KR,
                  Christina Bergqvist AG, Blackford R, Buchhalter JR, Caraballo
                  RH, Cross JH, Dahlin MG, Donner EJ, Guzel O, Jehle RS,
                  Klepper J, Kang HC, Lambrechts DA, Liu YMC, Nathan JK,
                  Nordli DR Jr, Pfeifer HH, Rho JM, Scheffer IE, Sharma S,
                  Stafstrom CE, Thiele EA, Turner Z, Vaccarezza MM, van der
                  Louw EJTM, Veggiotti P, Wheless JW, Wirrell EC; Charlie
                  Foundation; Matthew&#39;s
                </Typography>
                <Typography
                  sx={{
                    fontFamily: "Lato",
                  ...
                  id="modal-modal-title"
                >
                  Friends; Practice Committee of the Child Neurology Society.
                  Optimal clinical management of children receiving dietary
                  therapies for epilepsy: Updated recommendations of the
                  International Ketogenic Diet Study Group. Epilepsia Open. 2018
                  May 21;3(2):175-192. doi: 10.1002/epi4.12225. PMID:
                  29881797; PMCID: PMC5983110.
                </Typography>
              </Box>
            </Modal>
          </span>
        ...
        >
          B-Life considera el respeto uno de sus principales valores,
          demostrándolo en cada contacto y en cada lugar en el que está presente.
        </Typography>
        <Typography
          sx={{
            fontFamily: "Lato",
        ...
        >
          B-Life busca escuchar las necesidades de sus clientes para satisfacerlas,
          desarrollando y poniendo a su disposición todos aquellos recursos
          necesarios para llevar adelante el tratamiento.
        </Typography>
        <Typography
          sx={{
            fontFamily: "Lato",
        ...
        >
          Por último, se compromete en brindar a los profesionales de la salud
          capacitación continua y acceso a la información científica.
        </Typography>
      </Box>
    </Box>
