...
const APLV = () => {
  ...
  <Box position={"absolute"} left={"6%"} top={"24%"} zIndex={100}>
    <img width={"18%"} src="/logoCarrusel.png" alt="" />
    <Typography
      sx={{
        fontFamily: "Lato",
  ...
  >
    ...
    >
      <Box width={"48%"} ml={2}>
        ...
        >
          La alergia a las proteínas de la leche de vaca (APLV) es el resultado
          de una respuesta inmunológica anómala que ocurre después de la ingesta
          de proteína de leche de vaca (PLV), que obedece a diferentes
          mecanismos: mediado por inmunoglobulina E (IgE), no mediado por IgE o
          de naturaleza mixta. La APLV puede manifestarse en lactantes que se
          alimentan con leche materna exclusivamente o bien con fórmulas
          infantiles.
        </Typography>
        <Typography
          sx={{
        ...
        >
          La dieta de eliminación diagnóstica se basa en la exclusión completa
          de las proteínas alergénicas (PLV) de la dieta para revertir las
          manifestaciones clínicas de la APLV. Después de la recuperación
          clínica y nutricional, se debe realizar la prueba de reto oral o
          enfrentamiento para comprobar el diagnóstico de APLV. Una vez
          confirmado el diagnóstico, se debe iniciar la dieta de eliminación
          terapéutica, que continuará hasta el momento del desarrollo de la
          tolerancia.
        </Typography>
        <Typography
          sx={{
        ...
        >
          En el caso de pacientes con formas graves de APLV que se alimentan con
          fórmulas infantiles, la fórmula de aminoácidos se recomienda como
          primera opción terapéutica, ya que tiene mayor eficacia y menor
          potencial de desencadenar reacciones alérgicas graves. Su principal
          inconveniente es su elevado costo y la necesidad de prescripción y
          seguimiento médico especializado. Las fórmulas parcialmente hidrolizadas
          y las extensamente hidrolizadas son eficaces en pacientes con formas
          leves de APLV, pero tienen un menor grado de eficacia que las fórmulas
          de aminoácidos.
        </Typography>
      </Box>
      <Box width={"48%"} ml={2}>
        ...
        >
          Para determinar la severidad de la alergia y las opciones de manejo,
          el diagnóstico se basa en la historia clínica, la exploración física,
          la evaluación de las manifestaciones clínicas y su gravedad, las
          pruebas cutáneas y la medición de las concentraciones de IgE
          específica y total. La evaluación y el manejo de la APLV debe ser
          realizado por un equipo interdisciplinario que incluya pediatras,
          gastroenterólogos, nutriólogos, inmunólogos y otros especialistas,
        ...
        >
          Los pacientes con APLV deben recibir educación dietética, y los
          padres y cuidadores deben recibir orientación sobre las fórmulas
          infantiles adecuadas y la forma correcta de prepararlas, además de
          instrucciones sobre cómo reconocer y manejar las reacciones
          alérgicas. Los pacientes con APLV deben ser monitorizados
          periódicamente para evaluar la adecuación de la dieta y la
          tolerancia.
        </Typography>
        <Typography
          sx={{
        ...
        >
          El objetivo del tratamiento de la APLV es prevenir las reacciones
          alérgicas y asegurar una nutrición óptima y un crecimiento y
          desarrollo adecuados. El tratamiento incluye la eliminación de las
          proteínas alergénicas de la dieta, la administración de fórmulas
          infantiles seguras, el control de los síntomas y la prevención y
          tratamiento de las reacciones alérgicas. El tratamiento farmacológico
          incluye antihistamínicos, corticosteroides, broncodilatadores y
          epinefrina.
        </Typography>
      </Box>
    </Box>
    <Box mt={20} bgcolor={"#75ccf4"} textAlign={"center"} p={5}>
      <Typography
        sx={{
          fontFamily: "Lato",
          fontWeight: "bold",
      ...
      >
        © 2024 B-Life. Todos los derechos reservados.{" "}
