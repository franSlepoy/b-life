...
const SustitutoDeHuevo = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/brochureZeropro.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "brochureZeropro.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Polvo, ideal para ligar y leudar preparaciones culinarias bajas
                en proteínas en reemplazo del huevo natural, para el tratamiento
            ...
            >
              <Box>
                <img height={"300px"} src="/sustitutoDeHuevo.png" alt="" />
              </Box>
...
export default SustitutoDeHuevo;
