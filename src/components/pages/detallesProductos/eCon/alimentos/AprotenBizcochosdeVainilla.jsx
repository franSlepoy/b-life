...
const AprotenBizcochosdeVainilla = () => {
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Masitas de vainilla de bajo contenido proteico para el
            ...
            >
              <Box>
                <img
                  height={"300px"}
                  src="/aprotenBizcochosdeVainilla.png"
                  alt=""
                />
              </Box>
          ...
          <Box mt={"150px"}>
            ...
            >
              <Box textAlign={"center"}>
                <img
                  height={"300px"}
                  src="/aprotenBizcochosdeCacao.png"
                  alt=""
                />
              </Box>
...
export default AprotenBizcochosdeVainilla;
