        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Pasta tipo cinta, de bajo contenido proteico para el tratamiento
            ...
            >
              <Box>
                <img height={"300px"} src="/aprotenTagliatelle.png" alt="" />
              </Box>
...
export default AprotenTagliatelle;
