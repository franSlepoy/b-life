      ...
      <Hidden smDown>
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            ...
            >
              <Box>
                <img height={"300px"} src="/aprotenSpaguetti.png" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                ...
                dietas restringidas en el aporte de proteínas. TIEMPO DE
...
export default AprotenSpaguetti;
