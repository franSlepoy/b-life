        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Sustituto de harina adecuada para la elaboración de amasados
                hipoproteicos dulces y salados como, panes, pizzas, tortas y
                otras preparaciones de bajo contenido proteico, para el
            ...
            >
              <Box>
                <img height={"300px"} src="/aprotenHarina.png" alt="" />
              </Box>
