        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Chocolate con bajo contenido proteico, ideal para el tratamiento
            ...
            >
              <Box>
                <img height={"300px"} src="/schoxxiTafel.png" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                ...
                el aporte de proteínas. Precaución: Producto con alto contenido
                de sodio. Su uso en pacientes renales debe ser consultado
