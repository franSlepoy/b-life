        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Sustituto de leche en polvo a base de almidón de papa y
                maltodextrina para mayores de 1 año de edad. Ideal para dietas
                restringidas.
              </Typography>
              <Typography
                sx={{
            ...
            >
              <Box>
                <img height={"300px"} src="/freeMilk.png" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                Puede utilizarse en niños y adultos con patologías que posean
                restricciones en lactosa, grasas, caseína, proteínas y/o
                aminoácidos.
              </Typography>
            </Box>
            <Box ml={3} width={"33.3%"}>
              ...
              >
                La dilución recomendada es al 21% (3 medidas de Freemilk = 25 g
                de polvo + 120 c de agua tibia).
              </Typography>
            </Box>
