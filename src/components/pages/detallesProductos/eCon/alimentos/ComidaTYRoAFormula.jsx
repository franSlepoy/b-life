...
const ComidaTYRoAFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/comidaTYRoAFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "cerealChocolate.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida TYRo A Fórmula es una fórmula infantil en polvo libre de
                fenilalanina y tirosina para el tratamiento nutricional de
                Tirosinemia Tipo I, II y III en lactantes de 0 a 1 año edad.
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaTYRoAFormula.jpg" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                TYRo A Fórmula está indicado en el tratamiento nutricional de
                lactantes de 0 a 1 año de edad con Tirosinemia Tipo I, II y III.
              </Typography>
              <Typography
                sx={{
                  color: "#007E48",
            ...
            <Box ml={3} width={"33.3%"}>
              ...
              >
                La dilución recomendada es del 13% P/V (3 medidas de Comida TYRo A Fórmula = 13 g de polvo + 90 cc de agua). Se recomienda distribuir la cantidad diaria indicada por el profesional en varias tomas a lo largo del día. 
...
export default ComidaTYRoAFormula;
