...
const Chocotino = () => {
  const handleDownloadPDF = () => {
    ...
    link.href = pdfURL;
    link.download = "brochureMevalia.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Producto a base de azúcar y manteca de cacao sabor chocolate
                ideal para el tratamiento nutricional de patologías que
            ...
            >
              <Box>
                <img height={"300px"} src="/chocotino.png" alt="" />
              </Box>
