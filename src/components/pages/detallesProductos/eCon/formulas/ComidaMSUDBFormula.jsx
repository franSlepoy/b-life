...
const ComidaMSUDBFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaMSUDBFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaMSUDBFormula.pdf"; // Nombre del archivo a descargar
      ...
      <Hidden smDown>
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaMSUDBFormula.jpg" alt="" />
              </Box>
          ...
          <Box mt={"150px"}>
            ...
            >
              <Box textAlign={"center"}>
                <img height={"300px"} src="/comidaMSUDAFormula.jpg" alt="" />
              </Box>
...
export default ComidaMSUDBFormula;
