...
const ComidaMSUDAFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaMSUDAFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaMSUDAFormula.pdf"; // Nombre del archivo a descargar
...
export default ComidaMSUDAFormula;
