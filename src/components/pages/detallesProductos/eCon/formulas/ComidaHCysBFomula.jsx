...
const ComidaHCysBFomula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaHCysBFomula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaHCysBFomula.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida HCys B Fórmula es una fórmula en polvo libre metionina
                para el tratamiento nutricional de Homocistinuria en niños
                mayores de 1 año de edad, adolescentes y adultos. Alimento para
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaHCysBFormula.jpg" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                Comida HCys B Fórmula está indicado en el tratamiento
            ...
            <Box ml={3} width={"33.3%"}>
              ...
              >
                ...
                HCys B Fórmula = 15 g de polvo + 90 cc de agua). Se recomienda
...
export default ComidaHCysBFomula;
