...
const GlytactinComplete15 = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/GlytactinComplete15.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "GlytactinComplete15.pdf"; // Nombre del archivo a descargar
      ...
      <Hidden smDown>
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            ...
            >
              <Box>
                <img height={"300px"} src="/complete15BarPbFf.png" alt="" />
              </Box>
...
export default GlytactinComplete15;
