...
const ComidaGAcBFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaGAcBFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaGAcBFormula.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida GAc B Fómula es una fórmula en polvo libre de lisina y de
                bajo contenido en triptófano para el tratamiento nutricional de
                la Aciduria Glutárica Tipo I en niños mayores de 1 año de edad,
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaGAcBFormula.png" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            ...
            <Box ml={3} width={"33.3%"}>
              ...
              >
                La dilución recomendada es del 15% P/V (2 medidas de Comida GAc
                B Fómula = 15 g de polvo + 90cc de agua). Se recomienda
          ...
          <Box mt={"150px"}>
            ...
            >
              <Box textAlign={"center"}>
                <img height={"300px"} src="/comidaGAcAFormula.png" alt="" />
              </Box>
          ...
          <Box width={"100%"}>
            <Box mt={3}>
              ...
              >
                Comida GAc B Fórmula está indicado en el tratamiento nutricional
                de niños mayores de 1 año de edad, adolescentes y adultos con
                Aciduria Glutárica Tipo I. <strong>EQUIVALENTE PROTEICO: </strong>31 g de
...
export default ComidaGAcBFormula;
