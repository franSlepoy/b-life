...
const ComidaGAcAFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaGAcAFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaGAcAFormula.pdf"; // Nombre del archivo a descargar
          ...
          <Box width={"100%"}>
            <Box mt={3}>
              ...
              >
                Comida GAc A Fórmula está indicado en el tratamiento nutricional
                de lactantes de 0 a 1 año de edad con Aciduria Glutárica Tipo I.
                <strong> EQUIVALENTE PROTEICO: </strong>12 g de equivalente proteico por 100 g de
                polvo.
              </Typography>
            </Box>
            <Box width={"100%"}>
...
export default ComidaGAcAFormula;
