...
const XPHEEnergyK = () => {
  const handleDownloadPDF = () => {
    ...
    const pdfURL = "/XPHEEnergyK.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "XPHEEnergyK.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                ...
                >
                  • Contiene vitaminas, minerales, elementos traza.
                </Typography>
            ...
            >
              <Box>
                <img height={"300px"} src="/XPheEnergyK.png" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            ...
            <Box ml={3} width={"33.3%"}>
              ...
              >
                La dilución recomendada es 16,5 % P/V (1 sobre = 16,5 g de polvo
                + 100 cc de agua). Se recomienda distribuir la cantidad diaria
