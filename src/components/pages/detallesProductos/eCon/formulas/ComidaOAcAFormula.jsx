...
const ComidaOAcAFormula = () => {
  const handleDownloadPDF = () => {
    ...
    link.href = pdfURL;
    link.download = "ComidaOAcAFormula.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida OAc A Fórmula es una fórmula infantil en polvo libre de
                isoleucina, metionina, treonina y valina para el tratamiento
                nutricional de Acidemias Orgánicas: Propiónica y Metilmalónica
                en lactantes de 0 a 1 año edad. Alimento para propósitos médicos
                específicos.
              </Typography>
              <Typography
                sx={{
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                Comida OAc A Fórmula está indicado en el tratamiento nutricional
                de lactantes de 0 a 1 año de edad con Acidemias Orgánicas:
                Propiónica y Metilmalónica. EQUIVALENTE PROTEICO: 12 g de
            ...
            <Box ml={3} width={"33.3%"}>
              ...
              >
                La dilución recomendada es del 13 % P/V (3 medidas de Comida OAc
