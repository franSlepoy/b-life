...
const ComidaLeuAFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaLeuAFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaLeuAFormula.pdf"; // Nombre del archivo a descargar
...
export default ComidaLeuAFormula;
