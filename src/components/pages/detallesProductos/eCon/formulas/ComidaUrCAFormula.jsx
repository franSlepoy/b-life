...
const ComidaUrCAFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaUrCAFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaUrCAFormula.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida UrC A Fórmula es una fórmula infantil en polvo a base de
                ...
                lactantes de 0 a 1 año de edad. Alimento para propósitos médicos
                específicos.
              </Typography>
              <Typography
                sx={{
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaUrCAFormula.jpg" alt="" />
              </Box>
...
export default ComidaUrCAFormula;
