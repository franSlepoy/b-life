...
const ComidaPKUBFormulaLO = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaPKUBFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaPKUBFormula.pdf"; // Nombre del archivo a descargar
        ...
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                Comida PKU B Fórmula (Orange - Lemon)
              </Typography>
              <Typography
                sx={{
                  color: "#0B3A25",
              ...
              >
                Comida PKU B Fórmula Orange-Lemon es una fórmula en polvo libre
                de fenilalanina para el tratamiento nutricional de
                Fenilcetonuria (PKU) o Hiperfenilalaninemia (HPA) en niños
                mayores de 3 años de edad, adolescentes y adultos. Alimento para
            ...
            >
              <Box>
                <img height={"300px"} src="/PKUBOrangeLemon.jpg" alt="" />
              </Box>
          ...
          <Box width={"70%"} display={"flex"}>
            <Box mt={3} width={"33.3%"}>
              ...
              >
                ...
                EQUILAVANTE PROTEICO: 31 g de equivalente proteico cada 100 g de
                polvo.
              </Typography>
            </Box>
            <Box ml={3} width={"33.3%"}>
...
export default ComidaPKUBFormulaLO;
