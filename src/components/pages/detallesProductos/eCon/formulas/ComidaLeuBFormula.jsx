...
const ComidaLeuBFormula = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/ComidaLeuBFormula.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "ComidaLeuBFormula.pdf"; // Nombre del archivo a descargar
      ...
      <Hidden smDown>
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            ...
            >
              <Box>
                <img height={"300px"} src="/comidaLeuBFormula.jpg" alt="" />
              </Box>
          ...
          <Box mt={"150px"}>
            ...
            >
              <Box textAlign={"center"}>
                <img height={"300px"} src="/comidaLeuAFormula.jpg" alt="" />
              </Box>
...
export default ComidaLeuBFormula;
