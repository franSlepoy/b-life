...
const KansoDeliMCTCacaoBiscuits = () => {
  const handleDownloadPDF = () => {
    // Construye la URL del archivo PDF
    const pdfURL = "/KansoDeliMCTCacaoBiscuits.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "KansoDeliMCTCacaoBiscuits.pdf"; // Nombre del archivo a descargar
...
export default KansoDeliMCTCacaoBiscuits;
