...
const Alimentos1 = () => {
  const handleDownloadPDF = () => {
    ...
    const pdfURL = "/Cetolate-Literatura.pdf";

    // Crea un enlace temporal
    const link = document.createElement("a");
    link.href = pdfURL;
    link.download = "Cetolate-Literatura.pdf"; // Nombre del archivo a descargar
      ...
      <Hidden smDown>
        <Box width={"60%"} m={"auto"}>
          <Box display={"flex"} mt={"15%"}>
            <Box>
              ...
              >
                <Typography sx={{ fontWeight: "regular", fontSize: "14px" }}>
                  • Específicamente diseñado para Terapia Cetogénica.
                </Typography>
                <Typography sx={{ fontWeight: "regular", fontSize: "14px" }}>
                  • Excelente sabor.
                </Typography>
                <Typography sx={{ fontWeight: "regular", fontSize: "14px" }}>
                  • Aporta 4,88 g de fibra por porción.
                </Typography>
                <Typography sx={{ fontWeight: "regular", fontSize: "14px" }}>
                  • Permite realizar una alta variedad de preparaciones
                  cetogénicas que requieren el uso de chocolate.
                </Typography>
                <Typography sx={{ fontWeight: "regular", fontSize: "14px" }}>
                  • Ideal para utilizar como snack o consumir en cualquier
                  momento y lugar.
                </Typography>
              </Box>
            </Box>
            ...
            >
              <Box>
                <img height={"300px"} src="/cetolate.png" alt="" />
              </Box>
